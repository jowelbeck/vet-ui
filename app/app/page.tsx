...
export default function Home() {
  ...
  const t = {
    ...
    petName: lang === "fr" ? "Nom de l'animal" : (speciesType === "poultry" ? "Farm name" : speciesType === "livestock" ? "Animal ID / Tag" : "Pet name"),
    breed: lang === "fr" ? "Race" : (speciesType === "poultry" ? "Breed / Strain" : speciesType === "livestock" ? "Breed" : "Breed"),
    age: lang === "fr" ? "Âge" : "Age",
    ...
    placeholderAnimal: lang === "fr" ? "Chien, chat, lapin…" : (speciesType === "poultry" ? "Chicken, Turkey, Duck…" : speciesType === "livestock" ? "Cattle, Goat, Sheep…" : "Dog, cat, rabbit…"),
    placeholderPetName: lang === "fr" ? "Buddy" : (speciesType === "poultry" ? "Kofi Farms" : speciesType === "livestock" ? "TAG-001" : "Buddy"),
    placeholderBreed: lang === "fr" ? "Labrador, Persan…" : (speciesType === "poultry" ? "Broiler, Layer, Noiler…" : speciesType === "livestock" ? "Friesian, Sahiwal…" : "Labrador, Persian…"),
