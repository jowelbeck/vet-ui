...
export default function FrenchLandingPage() {
  return (
    <main style={{ fontFamily: "system-ui, sans-serif", background: "#f8fafc", minHeight: "100vh" }}>
      <nav style={{ background: "#fff", borderBottom: "1px solid #e2e8f0", padding: "0 40px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64, position: "sticky", top: 0, zIndex: 100 }}>
        ...
        <div style={{ display: "flex", gap: 24, alignItems: "center" }}>
          ...
          <a href="/" style={{ fontSize: 12, fontWeight: 600, color: "#64748b", textDecoration: "none", padding: "5px 10px", borderRadius: 6, border: "1px solid #e2e8f0" }}>🇬🇧 EN</a>
        </div>
      </nav>
      ...
      <section style={{ background: "linear-gradient(135deg, #2C1810 0%, #4A2C1A 30%, #1B3A2D 70%, #0D2418 100%)", padding: "80px 40px", color: "#fff", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(134,239,172,0.15)", border: "1px solid rgba(134,239,172,0.4)", borderRadius: 24, padding: "6px 16px", marginBottom: 16 }}>
          ...
          <span style={{ color: "rgba(255,255,255,0.85)", fontSize: 13 }}>🚀 Mise à niveau majeure — Surveillance des maladies · Pratique mixte · Gestion des frontières</span>
        </div>
          <div style={{ display: "inline-block", background: "rgba(255,255,255,0.15)", borderRadius: 20, padding: "6px 16px", fontSize: 13, marginBottom: 24, color: "rgba(255,255,255,0.9)" }}>
            🐾 Système d'exploitation vétérinaire · Intelligence Clinique
          </div>
          <h1 style={{ fontSize: 52, fontWeight: 900, lineHeight: 1.1, marginBottom: 24, letterSpacing: "-1px" }}>
            Gérez votre clinique vétérinaire —<br />
            <em style={{ color: "#86efac", fontStyle: "normal" }}>avec un support clinique intelligent.</em>
          </h1>
          <p style={{ fontSize: 18, color: "rgba(255,255,255,0.8)", lineHeight: 1.7, marginBottom: 40, maxWidth: 580 }}>
            VetsAI est le système d'exploitation pour cliniques vétérinaires — dossiers patients, IA clinique, gestion de pharmacie et facturation en un seul endroit. Conçu pour animaux, volailles et bétail.
          </p>
          ...
          <p style={{ marginTop: 20, fontSize: 13, color: "rgba(255,255,255,0.5)" }}>Aucune carte bancaire · 3 mois gratuits · Annulez à tout moment</p>
        </div>
      </section>

      <section style={{ background: "#1a3d2b", padding: "24px 40px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 32 }}>
          {[
            ...
            { num: "100%", label: "Conçu pour l'Afrique" },
          ].map(s => (
      ...
      <section style={{ padding: "72px 40px", maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ textAlign: "center" as const, marginBottom: 48 }}>
          <h2 style={{ fontSize: 36, fontWeight: 800, color: "#1a3d2b", marginBottom: 12 }}>Tout ce dont votre clinique a besoin</h2>
          <p style={{ fontSize: 16, color: "#64748b" }}>8 modules intégrés, conçus pour fonctionner ensemble parfaitement.</p>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 20 }}>
          {[
            { icon: "🧠", title: "IA Clinique", desc: "Diagnostics différentiels, dosages médicamenteux et notes SOAP générés automatiquement.", color: "#f3e8ff" },
            { icon: "💊", title: "Pharmacie Vétérinaire", desc: "Gestion des stocks pour animaux, volailles et bétail — alertes péremption, fournisseurs et historique.", color: "#fef9c3" },
            { icon: "📁", title: "Dossiers Patients", desc: "Historique médical complet pour animaux, élevages et bétail — avec champs spécifiques par espèce.", color: "#dcfce7" },
            { icon: "🔬", title: "Résultats de Labo", desc: "Commandez et suivez les analyses — NFS, urines, coprologie et plus — avec alertes normal/anormal.", color: "#e0f2fe" },
            { icon: "💰", title: "Facturation", desc: "Générez des factures, suivez les paiements et gérez les finances de la clinique.", color: "#fce7f3" },
            { icon: "📅", title: "Rendez-vous", desc: "Planification, rappels et gestion du calendrier pour toute l'équipe.", color: "#ede9fe" },
            { icon: "👥", title: "Accès Multi-utilisateurs", desc: "Accès basé sur les rôles pour vétérinaires, infirmiers, techniciens et réceptionnistes.", color: "#ffedd5" },
            { icon: "📊", title: "Analytique", desc: "Tendances des cas, statistiques de pharmacie et performance de la clinique.", color: "#f0fdf4" },
          ].map(m => (
      ...
      <section style={{ background: "linear-gradient(135deg, #1a3d2b, #2d6a4f)", padding: "72px 40px", textAlign: "center" as const, color: "#fff" }}>
        <h2 style={{ fontSize: 40, fontWeight: 900, marginBottom: 16 }}>Prêt à transformer votre clinique ?</h2>
        <p style={{ fontSize: 18, color: "rgba(255,255,255,0.75)", marginBottom: 40, maxWidth: 500, margin: "0 auto 40px" }}>
          Rejoignez les cliniques vétérinaires à travers l'Afrique qui font confiance à VetsAI.
        </p>
        ...
        <p style={{ marginTop: 20, fontSize: 13, color: "rgba(255,255,255,0.4)" }}>Aucune carte bancaire · 3 mois gratuits · Annulez à tout moment</p>
      </section>
