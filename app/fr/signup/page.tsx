    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-signup { width: 100%; background: #1a3d2b; color: #fff; padding: 12px; border-radius: 8px; border: none; font-size: 15px; font-weight: 600; cursor: pointer; font-family: inherit; margin-top: 6px; }
        .btn-signup:disabled { opacity: 0.5; }
        ...
        .success { background: #f0faf4; border: 1px solid #d4f0e0; color: #1a3d2b; padding: 16px; border-radius: 8px; text-align: center; }
        ...
        .trust-item { font-size: 12px; color: #94a3b8; }
      `}</style>
        ...
        <div className="card">
          ...
          {success ? (
            <div className="success">
              <h3>✓ Compte créé !</h3>
              <p>Vous allez être redirigé vers la configuration de votre clinique…</p>
            </div>
          ) : (
            <>
              ...
              <div className="divider">
                ...
                <span className="divider-text">ou inscrivez-vous avec email</span>
                <div className="divider-line" />
              </div>
              <div className="field">
                <label>Adresse email</label>
                <input type="email" placeholder="vous@clinique.com" value={email} onChange={e => setEmail(e.target.value)} />
              </div>
              <div className="field">
                <label>Mot de passe</label>
                <input type="password" placeholder="Min. 6 caractères" value={password} onChange={e => setPassword(e.target.value)} />
              </div>
              ...
              <div className="footer-links">
                ...
                {" · "}
                <a href="/demo" className="link">Essayer la démo</a>
              </div>
            </>
          )}
        </div>
