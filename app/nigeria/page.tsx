    ...
    <main style={{ fontFamily: "system-ui, sans-serif", background: "#f8fafc", minHeight: "100vh" }}>
      ...
      <section style={{ background: "linear-gradient(135deg, #2C1810 0%, #4A2C1A 30%, #1B3A2D 70%, #0D2418 100%)", padding: "80px 40px", color: "#fff", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(134,239,172,0.15)", border: "1px solid rgba(134,239,172,0.4)", borderRadius: 24, padding: "6px 16px", marginBottom: 16 }}>
          ...
          <p style={{ marginTop: 20, fontSize: 13, color: "rgba(255,255,255,0.5)" }}>First 10 clinics get 1 month free · No credit card · Set up in 5 minutes</p>
        </div>
      </section>
      ...
      <section style={{ padding: "48px 40px", background: "#fff" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          {[
            { q: "Is VetsAI free?", a: "The first 10 clinics get 1 month free with no credit card required. After the trial, plans start from GHS 735/month." },
            ...
            { q: "How do I get support?", a: `Contact us via email at support@vetsai.vet. We respond within 24 hours.` },
          ].map(item => (
      ...
      <section style={{ background: "linear-gradient(135deg, #1a3d2b, #2d6a4f)", padding: "72px 40px", textAlign: "center", color: "#fff" }}>
        ...
        <p style={{ marginTop: 20, fontSize: 13, color: "rgba(255,255,255,0.4)" }}>First 10 clinics get 1 month free · No credit card</p>
      </section>

      <footer style={{ background: "#0f1f0f", padding: "32px 40px", color: "rgba(255,255,255,0.4)", fontSize: 13, textAlign: "center" }}>
       © {new Date().getFullYear()} VetsAI Technologies · vetsai.vet · <a href="mailto:support@vetsai.vet" style={{color:"rgba(255,255,255,0.4)"}}>support@vetsai.vet</a> · <a href="/privacy" style={{color:"rgba(255,255,255,0.4)"}}>Privacy</a> · <a href="/terms" style={{color:"rgba(255,255,255,0.4)"}}>Terms</a>
      </footer>
