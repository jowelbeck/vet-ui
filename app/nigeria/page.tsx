    ...
    <main style={{ fontFamily: "system-ui, sans-serif", background: "#f8fafc", minHeight: "100vh" }}>
      ...
      <section style={{ padding: "48px 40px", background: "#fff" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          {[
            { q: "Is VetsAI free?", a: "The first 10 clinics get First 10 clinics get 3 months free with no credit card required. After the trial, plans start from GHS 735/month." },
      ...
      <section style={{ background: "linear-gradient(135deg, #1a3d2b, #2d6a4f)", padding: "72px 40px", textAlign: "center", color: "#fff" }}>
        ...
        <p style={{ marginTop: 20, fontSize: 13, color: "rgba(255,255,255,0.4)" }}>First 10 clinics get First 10 clinics get 3 months free · No credit card</p>
      </section>
