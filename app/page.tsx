    ...
    <>
      ...
      <section className="hero" style={{ background: "linear-gradient(135deg, #2C1810 0%, #4A2C1A 30%, #1B3A2D 70%, #0D2418 100%)", position: "relative", overflow: "hidden" }}>
        ...
        <div className="hero-inner">
          ...
          <p className="hero-note">✅ No credit card required · ✅ First 10 clinics — first 10 clinics — first 10 clinics — 3 months free · ✅ Set up in 5 minutes · ✅ Cancel anytime</p>
      ...
      <section className="pricing-bg" id="pricing">
        <div className="section-inner">
          ...
          <p className="section-sub">First 10 clinics get first 10 clinics — first 10 clinics — 3 months free. No credit card required. Cancel anytime.</p>
