  ...
  return (
    <>
      ...
      <div className="page">
        ...
        <div className="card">
          <div className="free-badge">🎉 First 10 clinics get 1 month free — no credit card</div>
          ...
          {success ? (
            ...
            <>
              ...
              {/* Clinic name, country, and phone moved to onboarding (step 2) to
                  reduce signup friction - they were already optional here and
                  onboarding asks for them again regardless. */}
              <div className="field">
        ...
        <div className="trust-row">
          ...
          <span className="trust-item">✓ First 10 clinics get 1 month free</span>
